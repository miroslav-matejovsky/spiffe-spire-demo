# Scenario 06 — SPIRE Telemetry & Metrics

> **Complexity:** Advanced · **Previous:** [05-svid-api](../05-svid-api/README.md) · **Next:** [07-production](../07-production/README.md)
...
Ensure that the current working directory is `scenarios/06-metrics/` and run:
...
```powershell
podman exec -it metrics-spire-server /opt/spire/bin/spire-server entry create `
...
```powershell
podman exec -it metrics-spire-agent /opt/spire/bin/spire-agent api fetch x509 `
